...
Improv
Edit when the scene needs to be edited, then figure out what to do

Separate the creativity from the execution (BJ Novak)
Right down funny ideas when you think of them so that you can come back to later during the execution 
