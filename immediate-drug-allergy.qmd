...
![Tryptase and Histamine](images/drug-allergy/fig-tryptase-3.png){#fig-tryptase-3 fig-align="center"}
Tryptase is a natural serine protease

Elevated basal tryptase >= 11.5 ng/mL
Can get basal tryptase at 24 hrs after anaphylaxis event
...
increased: HaT, SM
CNV (alpha tryptase)
alpha or beta tryptase constitutively released (measure of MC burden)

TPSB2
Beta
preformed granule release during anaphylaxis/severe MC activation
