...
Sulfa antibiotics--also called sulfonylarylamines--are characterized by the presence of a sulfonamide functional (SO2NH2) group attached to a benzene ring.

Arylamine (aromatic amine) side chain linked the N4 position and a 5 or 6 member aromatic heterocyclic ring at the N1 position.
:::
...
No, they do not cross-react because non-antibiotic sulfonamides lack the same accessory groups as sulfa antibiotics--aryalmine and aromatic heterocyclic ring.
:::
...
First cases of PJP pneumonia (WWII orphanages): <https://pmc.ncbi.nlm.nih.gov/articles/PMC3323247/>
