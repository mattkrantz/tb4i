...
Gadolinium-based contrast agents (GBCA) are divided into three categories based on their stability: ionic linear, nonionic linear, and nonionic macrocyclic. When compared to macrocyclic GBCAs, linear GBCAs have a lower kinetic stability rate, meaning they take a shorter amount for the dissociation of "free" gadolinium. However, despite their lower stability, linear GBCAs seem to cause less adverse reactions than macrocyclic GBCAs.

The macrocyclic form cages the gadolinium ion leading to better protection while the linear form is an open flexible chain with weaker protection.

Gadolinium is a rare earth element—that does not exist in nature in its pure form due to its high reactivity—and can be extracted from minerals such as monazite and bastnesite.

All GBCAs are hypertonic in comparison to blood. However, nonionic GBCAs usually have a lower osmolality than ionic, as they do not have the additional contribution of Na+ or meglumine.

GBCAs consist of the combination of the gadolinium ion to its carrier molecule, also called "chelating agent." The carrier molecule serves to minimize the toxicity of gadolinium in its free form while preserving its contrast properties.
...
+--------------------------+------------------------------------------------+
| Class                    | Immediate Reactions per 10,000 Administrations |
+==========================+================================================+
| Nonioinic linear         | 1.5                                            |
+--------------------------+------------------------------------------------+
| Ionic linear             | 8.3                                            |
+--------------------------+------------------------------------------------+
| Nonionic macrocyclic     | 16                                             |
+--------------------------+------------------------------------------------+
