...
---
accordion:
  - macrolides-background:
    - header: What is the chemical structure of macrolides?
      body: Macrolides are defined by a large lactone ring, which varies from 12 to 16 carbons, with 1 or more attached sugar chains. Eyrthromycin and clarithromycin have 14 carbons in their lactone rings while azithromycin has 15.
    - header: What is the mechanism of action of macrolides?
      body: As 50S ribosomal subunit inhibitors, macrolides exert their bacteriostatic effect by inhibiting protein synthesis.
    - header: What is the cross-reactivity pattern macrolide antibiotics?
      body: While not extensively studied, macrolide antibiotics with a different number of carbon atoms in their lactone ring are tolerated by most patients. Macrolide antibiotics are also unlikely to cross-react with macrolide immunosuppressants (e.g., tacrolimus, sirolimus).
    - header: What are some infections that use macrolides as first-line therapy?
      body: Clarithyromycin is used as part of combination treatment for H. pylori. Azithromycin is a part of the first-line combination therapy for Mycobacterium avium complex.
filters:
  - accordion
---

{{< accordion macrolides-background >}}

#### Non-Hypersensitivity Reactions

<details>

<summary>GI Side Effects</summary>

Because macrolides are also agonists for the motilin receptor--stimulating gastric and small intestine motility--they can cause nausea, vomiting, diarrhea, and abdmoninal cramping. Accordingly, erythromycin can be used as a treatment for gastroparesis.

</details>

<details>

<summary>Sensorineural Otoxicity</summary>

Macrolides can cause usually, transient sensorineural ototoxicity.

</details>

<details>

<summary>QT Interval Prolongation</summary>

Macrolides are associated with QT interval prolongation.
...
<summary>What percent of the US population reports an allergy to penicillin?</summary>

Approximately 10% of the US population reports an allergy to penicillin while \< 5% of these reported penicillin allergies are clinically significant immediate or delayed-immune mediated drug reactions.

</details>

<details>

<summary>Of individuals reporting a penicillin allergy, what percent are clinically significant immediate or delayed immune-mediated drug reactions?</summary>
...
<summary>What infections are individuals with a history of penicillin allergy at higher risk of developing due to receiving broad-spectrum antibiotics?</summary>
...
<summary>What infection-related drug interaction is associated with individuals developing a maculopapular rash when receiving an aminopenicillin?</summary>
...
<summary>What percent of penicillin administrations result in a reaction that could be consistent with a hypersensitivity reaction, most often a rash, that could also be nonallergic?</summary>
...
<summary>Currently the rate of IgE-mediated penicillin allergies is decreasing. What is a potential hypothesis for this trend?</summary>
...
![2D skeletal representation of benzene from [Wikimedia](https://en.m.wikipedia.org/wiki/File:Benzene-Kekule-2D-skeletal.png)](images/specific-drugs/fig-benzene.png){#fig-benzene fig-align="center" width="119"}
...
**What is mechanism of most IV iron immediate hypersensitivity reactions?**
...
**Factors associated with a positive NSAID challenge**
